...
| Production runtime, backup, recovery, updates, maintenance, and support | Sprint 1/2/3 implemented; customer config validation remains | runtime and maintenance tests |
