"""Friendly Windows launcher for Saengngam Minimart POS 2.4."""
import ctypes
import json
import os
import secrets
...
LAUNCHER_TITLE = os.environ.get("POS_LAUNCHER_TITLE", "Saengngam POS 2.4")
...
class PosDesktop:
    ...
    def build_ui(self):
        ...
        tk.Label(header, text="POS Desktop Launcher · Version 2.4", fg="#cce6d5", bg="#0b3d2a", font=("Tahoma", 9)).pack(anchor="w", padx=25)
    ...
    def server_failed(self, detail):
        ...
        messagebox.showerror("POS 2.4", f"เริ่มเซิร์ฟเวอร์ไม่สำเร็จ\n\n{detail}\n\nดูรายละเอียดที่ runtime\\launcher.log")
