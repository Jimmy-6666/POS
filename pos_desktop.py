"""Friendly Windows launcher for Saengngam Minimart POS 3.0.6."""
import ctypes
import json
import os
import secrets
...
LAUNCHER_TITLE = os.environ.get("POS_LAUNCHER_TITLE", "Saengngam POS 3.0.6")
...
class PosDesktop:
    ...
    def build_ui(self):
        ...
        tk.Label(header, text="POS Desktop Launcher · Version 3.0.6", fg="#cce6d5", bg="#0b3d2a", font=("Tahoma", 9)).pack(anchor="w", padx=25)
    ...
    def server_failed(self, detail):
        ...
        messagebox.showerror("POS 3.0.6", f"เริ่มเซิร์ฟเวอร์ไม่สำเร็จ\n\n{detail}\n\nดูรายละเอียดที่ runtime\\launcher.log")
