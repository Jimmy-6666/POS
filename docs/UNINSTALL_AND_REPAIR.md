...
the Task Scheduler registration, and restores the private-LAN firewall rule.
...
Uninstall removes the production startup task, the dedicated production
firewall rule, and the application virtual environment. It preserves:
