...
def create_app(test_config=None):
    ...
    app.config.from_mapping(
        ...
        DIRECT_WINDOWS_PRINTING=os.environ.get("POS_DIRECT_WINDOWS_PRINTING", "").lower() in {"1", "true", "yes"},
        DIRECT_WINDOWS_PRINTER=os.environ.get("POS_RECEIPT_PRINTER", "POSPrinter POS-80").strip(),
