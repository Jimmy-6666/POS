...
CREATE TABLE IF NOT EXISTS products (
    ...
    requires_manual_price INTEGER NOT NULL DEFAULT 0 CHECK (requires_manual_price IN (0, 1)),
    is_online_available INTEGER NOT NULL DEFAULT 0 CHECK (is_online_available IN (0, 1)),
