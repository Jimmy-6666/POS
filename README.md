...
> Release 2.4.2 และ Desktop Launcher/LINE/Backup ล่าสุด โปรดดู `VERSION_2.4.2.md`
...
## 5. หา IP ของเครื่องใน LAN

เปิด Command Prompt แล้วรัน `ipconfig` มองหา **IPv4 Address** ของ Wi‑Fi/Ethernet ที่กำลังใช้ เช่น `192.168.1.10`

## 6. เปิดจากมือถือใน Wi‑Fi เดียวกัน

เปิด `http://192.168.1.10:8000` โดยเปลี่ยนเป็น IPv4 ของเครื่องหลัก เครื่องหลักต้องเปิดโปรแกรมอยู่ ห้าม forward พอร์ตนี้ออกอินเทอร์เน็ต
