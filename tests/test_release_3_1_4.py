...
class Release314Tests(unittest.TestCase):
    ...
    def test_release_identity_is_314_and_uat_is_explicit(self):
        ...
        self.assertIn('set "POS_APP_VERSION=3.2.0"', start_uat)
        self.assertIn("3.2.0 UAT", start_uat)
        self.assertIn("POS Desktop Launcher · Version 3.2.0", launcher)
        self.assertIn('messagebox.showerror("POS 3.2.0"', launcher)
